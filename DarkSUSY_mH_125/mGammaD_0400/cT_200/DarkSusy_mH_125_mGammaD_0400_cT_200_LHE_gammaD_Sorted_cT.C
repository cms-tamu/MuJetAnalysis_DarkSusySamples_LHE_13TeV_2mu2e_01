...
//=========  (Wed Apr 15 13:28:17 2015) by ROOT version5.34/22
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.0929102,10.375,0.6217836);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5717551);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.318669);
   h_gammaD_1_cT->SetBinContent(2,0.1163943);
   h_gammaD_1_cT->SetBinContent(3,0.04361477);
   h_gammaD_1_cT->SetBinContent(4,0.01564785);
   h_gammaD_1_cT->SetBinContent(5,0.005674081);
   h_gammaD_1_cT->SetBinContent(6,0.003127049);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3176417);
   h_gammaD_2_cT->SetBinContent(2,0.118116);
   h_gammaD_2_cT->SetBinContent(3,0.04266001);
   h_gammaD_2_cT->SetBinContent(4,0.01594389);
   h_gammaD_2_cT->SetBinContent(5,0.005638387);
   h_gammaD_2_cT->SetBinContent(6,0.00331744);
