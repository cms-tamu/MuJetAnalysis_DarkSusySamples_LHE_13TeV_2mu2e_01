...
//=========  (Wed Apr 15 14:06:43 2015) by ROOT version5.34/22
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-10.625,-0.01845485,51.875,0.1235055);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1135683);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.0637724);
   h_gammaD_1_cT->SetBinContent(2,0.02306334);
   h_gammaD_1_cT->SetBinContent(3,0.008763563);
   h_gammaD_1_cT->SetBinContent(4,0.003159223);
   h_gammaD_1_cT->SetBinContent(5,0.001241484);
   h_gammaD_1_cT->SetBinContent(6,0.0006863487);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.0630935);
   h_gammaD_2_cT->SetBinContent(2,0.02373732);
   h_gammaD_2_cT->SetBinContent(3,0.008728998);
   h_gammaD_2_cT->SetBinContent(4,0.003249407);
   h_gammaD_2_cT->SetBinContent(5,0.001190776);
   h_gammaD_2_cT->SetBinContent(6,0.0006660275);
