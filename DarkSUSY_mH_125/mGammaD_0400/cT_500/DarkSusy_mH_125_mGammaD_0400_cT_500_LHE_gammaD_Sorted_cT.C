...
//=========  (Wed Apr 15 13:33:04 2015) by ROOT version5.34/22
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.03728871,25.9375,0.2495475);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.229469);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1271718);
   h_gammaD_1_cT->SetBinContent(2,0.04707991);
   h_gammaD_1_cT->SetBinContent(3,0.01746504);
   h_gammaD_1_cT->SetBinContent(4,0.005966382);
   h_gammaD_1_cT->SetBinContent(5,0.002316895);
   h_gammaD_1_cT->SetBinContent(6,0.001413356);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1274828);
   h_gammaD_2_cT->SetBinContent(2,0.04719623);
   h_gammaD_2_cT->SetBinContent(3,0.01679489);
   h_gammaD_2_cT->SetBinContent(4,0.006336554);
   h_gammaD_2_cT->SetBinContent(5,0.002189542);
   h_gammaD_2_cT->SetBinContent(6,0.001306662);
